...
$req = compact("userid","title","firstname","lastname","sex","bloodtype","phone","email","facebook","address","amphoe","district","province","zipcode","hospital_id","casedescription","time_delete","status","profile_id","post_id");
...
if ($res != null) {
    ...
    try {
        ...
        if($_SESSION['userid'] == "admin"){
          header( "location: ../../../frontend/admin/postdetail.php?id=".$post_id."&status=edit_success");
        } else {
          header( "location: ../../../frontend/pages/management.php?postid=".$post_id."&status=edit_success");
        }
    ...
    if($_SESSION['status'] == "admin"){
      header( "location: ../../../frontend/admin/postdetail.php?id=".$post_id."&status=edit_success&email=null");
      exit(0);
    } else {
      header( "location: ../../../frontend/pages/management.php?postid=".$post_id."&status=edit_success&email=null");
      exit(0);
    }
    ...
    if($_SESSION['status'] == "admin"){
      header( "location: ../../../frontend/admin/postdetail.php?id=".$post_id."&status=fail");
    } else {
      header( "location: ../../../frontend/pages/management.php?postid=".$post_id."&status=fail");
    }
    exit(0);
}
