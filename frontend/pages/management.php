          ...
          <div class="card h-100" style="">
            ...
            <div class="row">
              <div class="col-12 text-center">
                ...
                <button type="button" class="btn btn-lg btn-success mr-right-20" onclick="sendEmail(<?php echo $_GET['postid']; ?>)" name="button">ส่งอีเมลร้องขอโลหิต</button>
                <a role="button"  class="btn btn-lg btn-warning mr-right-20" href="./editpost.php?postid=<?php echo $_GET['postid']; ?>" name="button">แก้ไขโพส</a>
                <a role="button" class="btn btn-lg btn-red-blood" href="../../backend/service/main/deletepost.php?post_id=<?php echo $_GET['postid']; ?>" name="button">ลบโพส</a>
              </div>
            </div>
          </div>
        </div>
