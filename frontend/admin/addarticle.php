...
.upload-btn-wrapper input[type=file] {
  ...
  <div class="row">
   ...
   <form class="" action="../../backend/service/main/postnews.php" enctype="multipart/form-data" method="post" runat="server">
     <div class="row">
   <div class="col" style="margin-bottom:20px">
     <h4>หัวข้อบทความ:</h4>
     <input type="text" class="form-control" name="topic" value="" placeholder="พิมพ์หัวข้อข่าวสารที่ต้องการ....">
   </div>
 </div>
 <div class="row">
   <div class="col-lg-6">
   ...
   <div class="row">
     ...
     <div class="col-lg-12 text-center" style="margin-bottom:20px">
       <button type="submit" class="btn btn-lg btn-success" name="button" style="width:200px">สร้างบทความ</button>
