    ...
    <div class="container" style="margin-top:100px">
      ...
      <div class="row">
          <div class="col-lg-12 col-md-6 text-center">
            ...
            <hr>
            <br>
            <a role="button" class="btn btn-lg btn-success" href="./addhospital.php"><i class="fa fa-plus"></i> เพิ่มโรงพยาบาล</a>
            <br>
            <br>
