            ...
            <div class="card-body mr-top-20">
              <div class="text-center">
                <!-- แบบฟรอ์มการสมัครสามาชก-->
                  <h3 class="card-title red-blood-color">แก้ไขข้อมูลส่วนตัว</h3>
                </div>
                ...
                <div class="row justify-content-md-center">
                  ...
                  <form class="" action="../../backend/service/main/edituser.php" onsubmit="return checkForm()" method="post" >
                    <div class="row mr-top-20">
                      <div class="col-12">
                        <label for="">เลขบัตรประชาชน</label>
                        <input type="text" id="idcard" name="idcard" class="form-control" placeholder="หมายเลขบัตรประจำตัวประชาชน" >
                      </div>
                    </div>
                    <div class="row mr-top-20">
                    ...
                    <div class="row justify-content-md-center mr-top-30 mr-bottom-50">
                      ...
                      <div class="col-lg-4 col-md-4 text-center mr-top-20 mr-bottom-30">
                        ...
                        <button class="btn btn-danger btn-lg btn-red-blood" type="submit" name="button" style="width:200px"  >แก้ไขข้อมูล</button>
                      </div>
                    </div>
                    </div>
...
//ฟักง์ชั่นการ fill ตำบล อำเภอ จังหวัด รหัสไปรษณีย์อัตโนมิต
 $.Thailand({
    ...
    $zipcode: $('#zipcode'), // input ของรหัสไปรษณีย์
     ...
     getEditProfile(<?php echo $_GET['id'];?>)
   </script>
  </body>
</html>
